...
class ConfigDialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.intern_radio)
        self.html_radio = QtGui.QRadioButton(self.widget)
        self.html_radio.setObjectName("html_radio")
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.html_radio)
        self.prince_radio = QtGui.QRadioButton(self.widget)
        self.prince_radio.setObjectName("prince_radio")
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.prince_radio)
        self.path_label = QtGui.QLabel(self.widget)
        self.path_label.setObjectName("path_label")
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.path_label)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.LabelRole, self.custom_radio)
        self.custom_edit = QtGui.QLineEdit(self.widget)
        self.custom_edit.setObjectName("custom_edit")
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.custom_edit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.prince_path_button.setText(QtGui.QApplication.translate("Dialog", "Select Executable", None, QtGui.QApplication.UnicodeUTF8))
